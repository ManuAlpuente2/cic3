  ...
  /**
		...
		'tabs' => array(
            ...
            array(
                ...
                'fields' => array(
                    ...
                    'sticky_hamburgers_color',
                    'sticky_hamburgers_secondary_color'
                ),
            ),
            array(
                'id'    => 'tab-7',
	...
	$cmb_demo->add_field( array(
		...
		'options'          => array(
			...
			'header9' => esc_html__( 'Header Style 4', 'rs-framework' ),				
			'header8' => esc_html__( 'Header Style 5', 'rs-framework' ),				
			'header4' => esc_html__( 'Header Style 6', 'rs-framework' ),				
			'header7' => esc_html__( 'Header Style 7', 'rs-framework' ),				
			'header10' => esc_html__( 'Header Style 8', 'rs-framework' ),				
		),
	) );
