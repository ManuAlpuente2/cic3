	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio4 .portfolio-item .portfolio-inner .p-icon i, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon a, {{WRAPPER}} .rs-portfolio-style6 .portfolio-item .portfolio-content h3 a i, {{WRAPPER}} .rs-portfolio-slider.slider-style-6 .portfolio-item .portfolio-content .p-icon i' => 'color: {{VALUE}};',                   
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-portfolio4 .portfolio-item .portfolio-inner .p-icon i, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon, {{WRAPPER}} .rs-portfolio-slider.slider-style-6 .portfolio-item .portfolio-content .p-icon i' => 'background: {{VALUE}};',                   
        ...
        $this->add_group_control(
            ...
            [
		        ...
		        'selector' => '{{WRAPPER}} .rs-portfolio4 .portfolio-item .portfolio-inner .p-icon i:hover, {{WRAPPER}} .rs-portfolio-style2 .portfolio-item .portfolio-content .p-icon:hover'
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-sliders .slick-next:hover, .rs-addon-sliders .slick-prev:hover' => 'background: {{VALUE}};',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs-portfolio-slider.rs-portfolio-style1.rs-custom .slick-prev' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );	
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs-portfolio-slider.rs-portfolio-style1.rs-custom .slick-prev' => 'left: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );	
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs-portfolio-slider.rs-portfolio-style1.rs-custom .slick-next' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .rs-portfolio-slider.rs-portfolio-style1.rs-custom .slick-next' => 'right: {{SIZE}}{{UNIT}};',
                ],
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'arrow_border_radius_custom',
            [
                'label' => esc_html__( 'Border Radius', 'rsaddon' ),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .rs-addon-sliders .slick-next, {{WRAPPER}} .rs-addon-sliders .slick-prev' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition' => [
        		    'arrows_custom_style' => 'custom',
        		],
        ...
        $this->add_group_control(
            ...
            [
                'name' => 'arrow_border_custom',
                'selector' => '{{WRAPPER}} .rs-addon-sliders .slick-next, {{WRAPPER}} .rs-addon-sliders .slick-prev',
                'condition' => [
        		    'arrows_custom_style' => 'custom',
        		],
            ]
