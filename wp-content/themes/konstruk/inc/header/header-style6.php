...
<header id="rs-header" class="header-style-6 header-style-three mainsmenu<?php echo esc_attr($main_menu_hides);?> <?php echo esc_attr($main_menu_icon);?>">
    ...
    <div class="header-inner<?php echo esc_attr($sticky_menu);?>">
       ...
       <?php
        ...
        ?>
        <div class="box-layout <?php echo esc_attr($header_width);?>" <?php echo wp_kses($menu_bg_color, 'konstruk');?>>
            <?php 
        ...
        <div class="col-cell last-cls">
            ...
            if(!empty($konstruk_option['quote'])):   
              $quote_menu = $konstruk_option['quote'];                        
            endif;        
            ?>
            ...
            <div class="col-cell header-quote">                         
                ...
                <div class="rs-contact-location">
                    ...
                    <span class="contact-inf">
                        ...
                        <span class="phone-line"><?php echo esc_html($konstruk_option['phone_line'])?></span>
                    </span>
                </div>
                <?php } ?>
