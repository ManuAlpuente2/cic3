            ...
            <div class="<?php echo esc_attr($header_width);?>">
                ...
                <div class="row-table">
                    ...
                    <div class="col-cell menu-responsive">  
                        <?php
                           if (!empty( $konstruk_option['logo-mobile']['url'] ) ) { ?>
                          <a href="<?php echo esc_url( home_url( '/' ) ); ?>" rel="home" class="mobile-logos"><img <?php echo wp_kses($logo_height, 'konstruk');?> src="<?php echo esc_url( $konstruk_option['logo-mobile']['url']); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>"></a>
                        <?php } else{?>
