...
if( empty($konstruk_option['enable_global'])) {
    ...
    <?php elseif( !empty( $konstruk_option['footer_bg_image']['url'])):?>
        <footer id="rs-footer" class="<?php echo esc_attr($footer_select);?> rs-footer footer-style-1" style="background-image: url('<?php echo esc_url($konstruk_option['footer_bg_image']['url']);?>'); background-position: <?php echo esc_attr($footer_bg_pos); ?>">
        <?php else:?>
            <footer id="rs-footer" class="<?php echo esc_attr($footer_select);?> rs-footer footer-style-1" >
    <?php endif;
    } else {
       if( !empty( $konstruk_option['footer_bg_image']['url'])):?>
        <footer id="rs-footer" class="<?php echo esc_attr($footer_select);?> rs-footer footer-style-1" style="background-image: url('<?php echo esc_url($konstruk_option['footer_bg_image']['url']);?>'); background-position: <?php echo esc_attr($footer_bg_pos); ?>">
        <?php else:?>
            <footer id="rs-footer" class="<?php echo esc_attr($footer_select);?> rs-footer footer-style-1" >
    <?php endif;
            ...
            <?php if(is_active_sidebar( 'copy_right'  )): ?>                      
                ...
                <div class="copy1">
                    <div class="copyright text-left" <?php if(!empty( $copy_space)): ?> style="padding: <?php echo esc_attr($copy_space); ?>" <?php endif; ?> >
                        <?php if(!empty($konstruk_option['copyright'])){?>
                        <p><?php echo wp_kses($konstruk_option['copyright'], 'konstruk'); ?></p>
                        <?php }
                         else{
                            ?>
...
<?php 
if(!empty($konstruk_option['show_top_bottom'])){
?>
 <!-- start scrollUp  -->
<div id="scrollUp">
