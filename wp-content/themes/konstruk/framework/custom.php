...
*/
add_action('wp_head', 'konstruk_custom_colors', 160);
function konstruk_custom_colors() { 
global $konstruk_option;	
/***styling options
------------------*/
	if(!empty($konstruk_option['body_bg_color']))
	{
	 $body_bg          = $konstruk_option['body_bg_color'];
	
	$body_color       = $konstruk_option['body_text_color'];	
	$site_color       = $konstruk_option['primary_color'];
	$secondary_color  = $konstruk_option['secondary_color'];
	$third_color  	  = $konstruk_option['third_color'];
	$link_color       = $konstruk_option['link_text_color'];	
	$link_hover_color = $konstruk_option['link_hover_text_color'];	
	$footer_bgcolor   = $konstruk_option['footer_bg_color'];
	$gradient_fst     = $konstruk_option['gradient_first_color'];
	$gradient_snd     = $konstruk_option['gradient_snd_color'];

	if(!empty($konstruk_option['menu_text_color'])){		
		$menu_text_color         = $konstruk_option['menu_text_color'];
	}
	if(!empty($konstruk_option['menu_text_hover_color'])){		
		$menu_text_hover_color   = $konstruk_option['menu_text_hover_color'];
	}
	if(!empty($konstruk_option['menu_text_active_color'])){		
		$menu_active_color       = $konstruk_option['menu_text_active_color'];
	}
	
	if(!empty($konstruk_option['menu_text_hover_bg'])){		
		$menu_text_hover_bg      = $konstruk_option['menu_text_hover_bg'];
	}
	if(!empty($konstruk_option['menu_text_active_bg'])){		
		$menu_text_active_bg     = $konstruk_option['menu_text_active_bg'];
	}
	
	if(!empty($konstruk_option['drop_text_color'])){		
		$dropdown_text_color     = $konstruk_option['drop_text_color'];
	}
	
	if(!empty($konstruk_option['drop_text_hover_color'])){		
		$drop_text_hover_color   = $konstruk_option['drop_text_hover_color'];
	}			
	
	if(!empty($konstruk_option['drop_text_hoverbg_color'])){		
		$drop_text_hoverbg_color = $konstruk_option['drop_text_hoverbg_color'];
	}
	
	if(!empty($konstruk_option['drop_down_bg_color'])){		
		$drop_down_bg_color = $konstruk_option['drop_down_bg_color'];
	}	
	
	$rs_top_style = get_post_meta(get_the_ID(), 'topbar-color', true);
    if($rs_top_style =='toplight' || $rs_top_style==''){
		$toolbar_bg    = $konstruk_option['toolbar_bg_color'];
		$toolbar_text  = $konstruk_option['toolbar_text_color'];
		$toolbar_link  = $konstruk_option['toolbar_link_color'];
		$toolbar_hover = $konstruk_option['toolbar_link_hover_color'];
	} else{
		$toolbar_bg    = $konstruk_option['toolbar_bg_color2'];
		$toolbar_text  = $konstruk_option['toolbar_text_color2'];
		$toolbar_link  = $konstruk_option['toolbar_link_color2'];
		$toolbar_hover = $konstruk_option['toolbar_link_hover_color2'];
    }

	//typography extract for body
	
	if(!empty($konstruk_option['opt-typography-body']['color']))
	{
		$body_typography_color=$konstruk_option['opt-typography-body']['color'];
	}
	if(!empty($konstruk_option['opt-typography-body']['line-height']))
	{
		$body_typography_lineheight=$konstruk_option['opt-typography-body']['line-height'];
	}
		
	$body_typography_font      =$konstruk_option['opt-typography-body']['font-family'];
	$body_typography_font_size =$konstruk_option['opt-typography-body']['font-size'];

	//typography extract for menu
	$menu_typography_color       =$konstruk_option['opt-typography-menu']['color'];	
	$menu_typography_weight      =$konstruk_option['opt-typography-menu']['font-weight'];	
	$menu_typography_font_family =$konstruk_option['opt-typography-menu']['font-family'];
	$menu_typography_font_fsize  =$konstruk_option['opt-typography-menu']['font-size'];
		
	if(!empty($konstruk_option['opt-typography-menu']['line-height']))
	{
		$menu_typography_line_height=$konstruk_option['opt-typography-menu']['line-height'];
	}
	
	//typography extract for heading
	
	$h1_typography_color=$konstruk_option['opt-typography-h1']['color'];		
	if(!empty($konstruk_option['opt-typography-h1']['font-weight']))
	{
		$h1_typography_weight=$konstruk_option['opt-typography-h1']['font-weight'];
	}
		
	$h1_typography_font_family=$konstruk_option['opt-typography-h1']['font-family'];
	$h1_typography_font_fsize=$konstruk_option['opt-typography-h1']['font-size'];	
	if(!empty($konstruk_option['opt-typography-h1']['line-height']))
	{
		$h1_typography_line_height=$konstruk_option['opt-typography-h1']['line-height'];
	}
	
	$h2_typography_color=$konstruk_option['opt-typography-h2']['color'];	

	$h2_typography_font_fsize=$konstruk_option['opt-typography-h2']['font-size'];	
	if(!empty($konstruk_option['opt-typography-h2']['font-weight']))
	{
		$h2_typography_font_weight=$konstruk_option['opt-typography-h2']['font-weight'];
	}	
	$h2_typography_font_family=$konstruk_option['opt-typography-h2']['font-family'];
	$h2_typography_font_fsize=$konstruk_option['opt-typography-h2']['font-size'];	
	if(!empty($konstruk_option['opt-typography-h2']['line-height']))
	{
		$h2_typography_line_height=$konstruk_option['opt-typography-h2']['line-height'];
	}
	
	$h3_typography_color=$konstruk_option['opt-typography-h3']['color'];	
	if(!empty($konstruk_option['opt-typography-h3']['font-weight']))
	{
		$h3_typography_font_weightt=$konstruk_option['opt-typography-h3']['font-weight'];
	}	
	$h3_typography_font_family = $konstruk_option['opt-typography-h3']['font-family'];
	$h3_typography_font_fsize  = $konstruk_option['opt-typography-h3']['font-size'];	
	if(!empty($konstruk_option['opt-typography-h3']['line-height']))
	{
		$h3_typography_line_height = $konstruk_option['opt-typography-h3']['line-height'];
	}

	$h4_typography_color = $konstruk_option['opt-typography-h4']['color'];	
	if(!empty($konstruk_option['opt-typography-h4']['font-weight']))
	{
		$h4_typography_font_weight = $konstruk_option['opt-typography-h4']['font-weight'];
	}	
	$h4_typography_font_family = $konstruk_option['opt-typography-h4']['font-family'];
	$h4_typography_font_fsize  = $konstruk_option['opt-typography-h4']['font-size'];	
	if(!empty($konstruk_option['opt-typography-h4']['line-height']))
	{
		$h4_typography_line_height = $konstruk_option['opt-typography-h4']['line-height'];
	}
	
	$h5_typography_color = $konstruk_option['opt-typography-h5']['color'];	
	if(!empty($konstruk_option['opt-typography-h5']['font-weight']))
	{
		$h5_typography_font_weight = $konstruk_option['opt-typography-h5']['font-weight'];
	}	
	$h5_typography_font_family = $konstruk_option['opt-typography-h5']['font-family'];
	$h5_typography_font_fsize  = $konstruk_option['opt-typography-h5']['font-size'];	
	if(!empty($konstruk_option['opt-typography-h5']['line-height']))
	{
		$h5_typography_line_height = $konstruk_option['opt-typography-h5']['line-height'];
	}
	
	$h6_typography_color = $konstruk_option['opt-typography-6']['color'];	
	if(!empty($konstruk_option['opt-typography-6']['font-weight']))
	{
		$h6_typography_font_weight = $konstruk_option['opt-typography-6']['font-weight'];
	}
	$h6_typography_font_family = $konstruk_option['opt-typography-6']['font-family'];
	$h6_typography_font_fsize  = $konstruk_option['opt-typography-6']['font-size'];	
	if(!empty($konstruk_option['opt-typography-6']['line-height']))
	{
		$h6_typography_line_height = $konstruk_option['opt-typography-6']['line-height'];
	}
?>
...
<style>	
	...
	<?php if(!empty($konstruk_option['team_single_bg_color']))
		{
			$team_single_bg_color = $konstruk_option['team_single_bg_color'];
		?>
		body.single-teams{
	...
	#rs-header .sticky_form{
		background: rgba(<?php echo esc_attr($site_color_rgb); ?>, 0.9) !important;
	}
	...
	<?php
		if(!empty($konstruk_option['transparent_toolbar_text_color'])){?>
			#rs-header.header-transparent .toolbar-area .toolbar-contact ul.rs-contact-info li,
			#rs-header.header-transparent .toolbar-area .toolbar-contact ul.rs-contact-info li i,
			#rs-header.header-transparent .toolbar-area .toolbar-contact ul.rs-contact-info li a,
			#rs-header.header-style-4 .btn_quote .toolbar-sl-share ul li a
			{
				color: <?php echo sanitize_hex_color($konstruk_option['transparent_toolbar_text_color']);?>
			}
		<?php } 
	
		if(!empty($konstruk_option['transparent_toolbar_link_hover_color'])){?>
			#rs-header.header-transparent .toolbar-area .toolbar-contact ul.rs-contact-info li:hover a,
			#rs-header.header-style-4 .btn_quote .toolbar-sl-share ul li a:hover{
			color: <?php echo sanitize_hex_color($konstruk_option['transparent_toolbar_link_hover_color']);?>
		}
		<?php } 
	?>
	#rs-header .toolbar-area .toolbar-contact ul.rs-contact-info li a,
	...
	<?php if(!empty($konstruk_option['transparent_menu_text_color'])) : ?>
		...
		#rs-header.header-transparent .menu-area .navbar ul li:hover > a{
			color:<?php echo sanitize_hex_color($konstruk_option['transparent_menu_text_color']); ?> 
	}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['transparent_menu_hover_color'])) : ?>
		#rs-header.header-style5 .header-inner .menu-area .navbar ul li:hover > a{
			color:<?php echo sanitize_hex_color($konstruk_option['transparent_menu_hover_color']); ?> 
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['toolbar_bg_color'])) : ?>
		#rs-header .toolbar-area{			
			background:<?php echo sanitize_hex_color($konstruk_option['toolbar_bg_color']); ?> 
		}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['transparent_menu_hover_color'])) : ?>
		#rs-header.header-style5 .header-inner .menu-area .navbar ul > li.menu-item-has-children.hover-minimize:hover > a:after{
			background:<?php echo sanitize_hex_color($konstruk_option['transparent_menu_hover_color']); ?> !important;  
		}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['transparent_menu_active_color'])) : ?>
		#rs-header.header-style5 .header-inner .menu-area .navbar ul > li.menu-item-has-children.hover-minimize > a:after{
			background:<?php echo sanitize_hex_color($konstruk_option['transparent_menu_active_color']); ?> !important; 
		}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['transparent_menu_active_color'])) : ?>
	...
	#rs-header.header-style5 .header-inner.menu-sticky.sticky .menu-area .navbar ul > li.current-menu-ancestor > a{
			color:<?php echo sanitize_hex_color($konstruk_option['transparent_menu_active_color']); ?> !important; 
		}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['transparent_menu_text_color'])) : ?> 
		...
		{
			background: <?php echo sanitize_hex_color($konstruk_option['transparent_menu_text_color']); ?> !important;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['menu_area_bg_color'])) : ?>
		#rs-header.header-style5 .header-inner .menu-area, 
		#rs-header .menu-sticky .menu-area,
		#rs-header.header-style-3.header-style-2 .sticky-wrapper .header-inner .box-layout{
		background:<?php echo sanitize_hex_color($konstruk_option['menu_area_bg_color']); ?> 
	}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['transparent_menu_text_color'])) : ?>
		#rs-header.header-transparent .menu-area.dark ul.offcanvas-icon .nav-link-container .nav-menu-link span{
			background:<?php echo sanitize_hex_color($konstruk_option['transparent_menu_text_color']); ?> 
		}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['offcanvas_bg_color'])) : ?>
		ul.offcanvas-icon .nav-link-container a{
			background:<?php echo sanitize_hex_color($konstruk_option['offcanvas_bg_color']); ?> 
		}
	<?php endif; ?>	
	<?php if(!empty($konstruk_option['offcanvas_bg_hover'])) : ?>
		ul.offcanvas-icon .nav-link-container a:hover{
			background:<?php echo sanitize_hex_color($konstruk_option['offcanvas_bg_hover']); ?> 
		}
	<?php endif; ?>	
	<?php if(!empty($konstruk_option['offcanvas_text_color'])) : ?>
		...
		#rs-header.header-transparent ul.offcanvas-icon .nav-link-container .nav-menu-link span, 
		#rs-header.header-style5 .menu-responsive ul.offcanvas-icon .nav-link-container .nav-menu-link span{
			background:<?php echo sanitize_hex_color($konstruk_option['offcanvas_text_color']); ?> !important;
		}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['offcanvas_dots_secondary_color'])) : ?>
		...
		#rs-header.header-transparent ul.offcanvas-icon .nav-link-container .nav-menu-link span, 
		#rs-header.header-style5 .menu-responsive ul.offcanvas-icon .nav-link-container .nav-menu-link span{
			background:<?php echo sanitize_hex_color($konstruk_option['offcanvas_dots_secondary_color']); ?> !important;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcanvas_dots_close_secondary_color'])) : ?>
		.flaticon-cross.closes:before{
			color:<?php echo sanitize_hex_color($konstruk_option['offcanvas_dots_close_secondary_color']); ?> !important;
		}
	<?php endif; ?>
	...
	<?php if(!empty($konstruk_option['drop_text_color'])) : ?>
		.menu-area .navbar ul li .sub-menu li a,
		#rs-header .menu-area .navbar ul li.mega ul li a,
		#rs-header.header-transparent .menu-area .navbar ul li .sub-menu li.current-menu-ancestor > a,
		#rs-header.header-transparent .menu-area .navbar ul li.current-menu-ancestor li a{
			color:<?php echo sanitize_hex_color($konstruk_option['drop_text_color']); ?> !important;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['drop_text_hover_color'])) : ?>
		...
		#rs-header.header-transparent .menu-area .navbar ul li.current-menu-ancestor li a:hover{
			color:<?php echo sanitize_hex_color($konstruk_option['drop_text_hover_color']); ?> !important;
		}
	<?php endif; ?>



	<?php if(!empty($konstruk_option['drop_down_bg_color'])) : ?>
		.menu-area .navbar ul li .sub-menu{
			background:<?php echo sanitize_hex_color($konstruk_option['drop_down_bg_color']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['toolbar_text_size'])) : ?>
		#rs-header .toolbar-area .toolbar-contact ul li,
		#rs-header .toolbar-area a,
		#rs-header .toolbar-area .toolbar-sl-share ul li{
			font-size:<?php echo esc_attr($konstruk_option['toolbar_text_size']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['menu_text_trasform'])) : ?>
		.menu-area .navbar ul > li > a,
		#rs-header .menu-area .navbar ul > li.mega > ul > li > a{
	...
	<?php if(!empty($konstruk_option['menu_text_trasform2'])) : ?>
	...
	<?php if(!empty($konstruk_option['toolbar_icon_color'])) : ?>
		#rs-header .toolbar-area .opening i,
		#rs-header .toolbar-area .toolbar-contact ul li i{
			color:<?php echo sanitize_hex_color($konstruk_option['toolbar_icon_color']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['copyright_bg_border'])) : ?>
		.footer-bottom .container{
			border-color:<?php echo esc_attr($konstruk_option['copyright_bg_border']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['foot_social_color_border'])) : ?>
		.rs-footer .widget ul.footer_social li i{
			border-radius:<?php echo esc_attr($konstruk_option['foot_social_color_border']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['foot_social_color_width'])) : ?>
		.rs-footer .widget ul.footer_social li i{
			width:<?php echo esc_attr($konstruk_option['foot_social_color_width']); ?>;
			height:<?php echo esc_attr($konstruk_option['foot_social_color_width']); ?>;
			line-height:<?php echo esc_attr($konstruk_option['foot_social_color_width']); ?>;
			box-shadow: none;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['copyright_text_color'])) : ?>
		.footer-bottom .copyright p{
			color:<?php echo sanitize_hex_color($konstruk_option['copyright_text_color']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['footer_text_size'])) : ?>
		.rs-footer, .rs-footer h3, .rs-footer a, 
		.rs-footer .fa-ul li a, 
		.rs-footer .widget.widget_nav_menu ul li a{
			font-size:<?php echo esc_attr($konstruk_option['footer_text_size']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['footer_h3_size'])) : ?>
		.rs-footer h3, .rs-footer .footer-top h3.footer-title{
			font-size:<?php echo esc_attr($konstruk_option['footer_h3_size']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['footer_link_size'])) : ?>
		.rs-footer a{
			font-size:<?php echo esc_attr($konstruk_option['footer_link_size']); ?>;
		}
	<?php endif; ?>	

	<?php if(!empty($konstruk_option['footer_text_color'])) : ?>
		.rs-footer, .rs-footer .footer-top h3.footer-title, .rs-footer a, .rs-footer .fa-ul li a,
		.rs-footer .widget.widget_nav_menu ul li a
		{
			color:<?php echo sanitize_hex_color($konstruk_option['footer_text_color']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['footer_title_color'])) : ?>
		.rs-footer .footer-top h3.footer-title
		{
			color:<?php echo sanitize_hex_color($konstruk_option['footer_title_color']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['footer_icon_color'])) : ?>
		.rs-footer .fa-ul li i
		{
			color:<?php echo sanitize_hex_color($konstruk_option['footer_icon_color']); ?>;
		}
	<?php endif; ?>

	
	<?php if(!empty($konstruk_option['footer_link_color'])) : ?>
		...
		.rs-footer .widget a:hover{
			color:<?php echo sanitize_hex_color($konstruk_option['footer_link_color']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['foot_social_color'])) : ?>	
		#rs-footer ul.footer_social > li > a,
		.rs-footer .widget ul.footer_social li i{
			color:<?php echo sanitize_hex_color($konstruk_option['foot_social_color']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['foot_social_hover'])) : ?>	
		#rs-footer ul.footer_social > li > a:hover,
		.rs-footer .widget ul.footer_social li i:hover{
			color:<?php echo sanitize_hex_color($konstruk_option['foot_social_hover']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['foot_social_color_bg'])) : ?>	
		#rs-footer ul.footer_social > li > a i,
		.rs-footer .widget ul.footer_social li i{
			background:<?php echo sanitize_hex_color($konstruk_option['foot_social_color_bg']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['foot_social_color_bg_hover'])) : ?>	
		#rs-footer ul.footer_social > li > a i:hover,
		.rs-footer .widget ul.footer_social li i:hover{
			background:<?php echo sanitize_hex_color($konstruk_option['foot_social_color_bg_hover']); ?>;
		}
	<?php endif; ?>



	<?php if(!empty($konstruk_option['footer_input_bg_color'])) : ?>
		.footer-subscribe input[type=submit],
		.footer-btn-wrap .footer-btn
		{
			background:<?php echo sanitize_hex_color($konstruk_option['footer_input_bg_color']); ?>
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['footer_input_hover_color'])) : ?>
		.footer-btn-wrap .footer-btn:hover,.footer-subscribe input[type=submit]:hover{
			background:<?php echo sanitize_hex_color($konstruk_option['footer_input_hover_color']); ?>;
		}
	<?php endif; ?>
	
	<?php if(!empty($konstruk_option['footer_input_border_color'])) : ?>
		.rs-footer .footer-top .mc4wp-form-fields input[type="email"]{
			border-color:<?php echo esc_attr($konstruk_option['footer_input_border_color']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['footer_input_text_color'])) : ?>
		.rs-footer .footer-top .mc4wp-form-fields input[type="submit"],
		.rs-footer .footer-top .mc4wp-form-fields i{
			color:<?php echo sanitize_hex_color($konstruk_option['footer_input_text_color']); ?>;
		}
	<?php endif; ?>
	...
	<?php 
		if(!empty($konstruk_option['link_hover_text_color'])){
			?>
			#rs-services-slider .item-thumb .owl-dot.service_icon_style.active .tile-content a, 
			#rs-services-slider .item-thumb .owl-dot.service_icon_style:hover .tile-content a,
			.team-grid-style2 .appointment-bottom-area .app_details:hover a, .team-slider-style2 .appointment-bottom-area .app_details:hover a{
				color: <?php echo sanitize_hex_color($konstruk_option['link_hover_text_color']); ?> !important;	
			}
		<?php
		}
	?>
	...
	<?php 
		if(!empty($konstruk_option['stiky_menu_area_bg_color'])){
			?>
			#rs-header .menu-sticky.sticky .menu-area,
			#rs-header.header-style-3.header-style-2 .sticky-wrapper .header-inner.sticky .box-layout{
				background: <?php echo sanitize_hex_color($konstruk_option['stiky_menu_area_bg_color']); ?> !important;	
			}
		<?php
		}
	?>
	...
	<?php 
		if(!empty($konstruk_option['stikcy_menu_text_color'])){
			?>
			#rs-header.header-style-4 .header-inner.sticky .nav-link-container .nav-menu-link span{
				background: <?php echo sanitize_hex_color($konstruk_option['stikcy_menu_text_color']); ?>;	
			}
		<?php
		}
	?>
	...
	<?php 
		if(!empty($konstruk_option['stikcy_menu_text_color'])){
			...
			#rs-header.header-style-4 .header-inner.sticky .btn_quote .toolbar-sl-share ul li a{
				color: <?php echo sanitize_hex_color($konstruk_option['stikcy_menu_text_color']); ?>;
			}
		<?php
		}
	?>	
	...
	<?php 
		if(!empty($konstruk_option['stikcy_menu_text_active_color'])){
			?>
			...
			#rs-header.header-style-4 .menu-sticky.sticky .menu-area .menu > li.current-menu-ancestor > a{
				color: <?php echo sanitize_hex_color($konstruk_option['stikcy_menu_text_active_color']); ?> !important;	
			}
		<?php
		}
	?>

	<?php if(!empty($konstruk_option['sticky_drop_down_bg_color'])) : ?>
		.menu-sticky.sticky .menu-area .navbar ul li .sub-menu{
			background:<?php echo sanitize_hex_color($konstruk_option['sticky_drop_down_bg_color']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['sticky_menu_text_hover_color'])) : ?>
		#rs-header.header-style-4 .header-inner.sticky .nav-link-container .nav-menu-link:hover span{
			background:<?php echo sanitize_hex_color($konstruk_option['sticky_menu_text_hover_color']); ?>;
		}
	<?php endif; ?>

	<?php 
		if(!empty($konstruk_option['sticky_menu_text_hover_color'])){
			?>
			#rs-header .menu-sticky.sticky .menu-area .navbar ul > li:hover > a,
			#rs-header.header-style-4 .header-inner.sticky .btn_quote .toolbar-sl-share ul > li a:hover,
			#rs-header.header-style-4 .header-inner.sticky .sidebarmenu-search i:hover,			
			#rs-header .menu-sticky.sticky .menu-area .navbar ul li ul.submenu > li.current-menu-ancestor > a{
				color: <?php echo sanitize_hex_color($konstruk_option['sticky_menu_text_hover_color']); ?> !important;	
			}
		<?php
		}
	?>
	...
	<?php
		if(!empty($konstruk_option['toolbar_link_color'])){?>
			#rs-header .toolbar-area .toolbar-sl-share ul li a.quote-buttons{
			color: <?php echo sanitize_hex_color($konstruk_option['toolbar_link_color']);?>
		}
		<?php } 
	?>	

	<?php 
		if(!empty($konstruk_option['stikcy_drop_text_color'])){
			?>
			#rs-header .menu-sticky.sticky .menu-area .navbar ul li .sub-menu li a{
				color: <?php echo sanitize_hex_color($konstruk_option['stikcy_drop_text_color']); ?> !important;	
			}
		<?php
		}
	?>
	...
	<?php 
		if(!empty($konstruk_option['sticky_drop_text_hover_color'])){
			?>
			#rs-header .menu-sticky.sticky .menu-area .navbar ul li .sub-menu li a:hover,
			#rs-header .menu-sticky.sticky .menu-area .navbar ul li .sub-menu li.current-menu-item page_item a,
			#rs-header .menu-sticky.sticky .menu-area .navbar ul  li .sub-menu li.current_page_item > a
			{
				color: <?php echo sanitize_hex_color($konstruk_option['sticky_drop_text_hover_color']); ?> !important;	
			}
		<?php
		}
	?>	
	...
	<?php 
		if(!empty($konstruk_option['footer_bg_color'])){?>
		.rs-footer{
			background: <?php echo sanitize_hex_color($konstruk_option['footer_bg_color']); ?>;
...
?>
	...
	<?php if(!empty($konstruk_option['btn_icon_bg_color'])) : ?>
		.rs-btn.style3 a:after{
			background:<?php echo esc_attr($konstruk_option['btn_icon_bg_color']); ?>;	
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['btn_bg_color'])) : ?>
		.wpcf7-submit,
		...
		.rs-btn a{
			background:<?php echo esc_attr($konstruk_option['btn_bg_color']); ?>;	
		}
		.wp-block-file .wp-block-file__button{
			border-color:<?php echo esc_attr($konstruk_option['btn_bg_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['btn_border_radius'])) : ?>
		.rs-blog-details .bs-info.tags a,
		.wpcf7-submit,
		.comments-area .comment-list li.comment .reply a,
		.comment-respond .form-submit #submit,
		...
		#rs-header .btn_quote a,
		.rs-btn a{
			border-radius:<?php echo esc_attr($konstruk_option['btn_border_radius']); ?>;	
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['toolbar_bg_skew_color'])) : ?>		
		#rs-header.header-style7 .toolbar-area:after{
			background:<?php echo sanitize_hex_color($konstruk_option['toolbar_bg_skew_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['btn_bg_hover_border'])) : ?>
		.woocommerce #respond input#submit.alt:hover, .woocommerce #respond input#submit:hover, .woocommerce .wc-forward:hover, .woocommerce a.button.alt:hover, .woocommerce a.button:hover, .woocommerce button.button.alt:hover, .woocommerce button.button:hover, .woocommerce input.button.alt:hover, .woocommerce input.button:hover{
			border:1px solid <?php echo esc_attr($konstruk_option['btn_bg_hover_border']); ?>;			
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['btn_bg_hover'])) : ?>
		.rs-btn a:hover,
		...
		#rs-header .btn_quote a:hover{
		background:<?php echo esc_attr($konstruk_option['btn_bg_hover']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['btn_text_color'])) : ?>
		.wpcf7-submit,
		.comments-area .comment-list li.comment .reply a,
		wp-block-file .wp-block-file__button,
		#rs-header .btn_quote a,
		...
		.submit-btn .wpcf7-submit{
			color:<?php echo sanitize_hex_color($konstruk_option['btn_text_color']); ?>;			
		}
	<?php endif; ?>

	 <?php if(!empty($konstruk_option['border_width_header'])) { ?>
	 	.show-header-border #rs-header .menu-sticky .menu-area{
	 		border-width: <?php echo esc_html($konstruk_option['border_width_header']) ;?>
	 	}
	 <?php }?>

	 <?php if(!empty($konstruk_option['gap_header'])) { ?>
	 	#rs-header .menu-sticky .menu-area{
	 		padding-top: <?php echo esc_html($konstruk_option['gap_header']) ;?>;
	 		padding-bottom: <?php echo esc_html($konstruk_option['gap_header']) ;?>
	 	}
	 <?php }?> 
	...
	<?php if(!empty($konstruk_option['btn_txt_hover_color'])) : ?>
		.rs-btn a:hover,
		#rs-header .btn_quote a:hover,
		.submit-btn .wpcf7-submit:hover, 
		#rs-header.header-style-3 .btn_quote .quote-button:hover{
			color:<?php echo sanitize_hex_color($konstruk_option['btn_txt_hover_color']); ?>;
		}
	<?php endif; ?>
	...
	<?php if(!empty($konstruk_option['container_size'])) : ?>
		@media only screen and (min-width: 1300px) {
			.container{
				max-width:<?php echo esc_attr($konstruk_option['container_size']); ?>;
			}
		}
	<?php endif; ?>
	...
	<?php if(!empty($konstruk_option['logo-height-mobile'])) : ?>
		@media only screen and (max-width: 991px) {
			#rs-header .logo-area a img, #rs-header .mobile-logos img{
				max-height:<?php echo esc_attr($konstruk_option['logo-height-mobile']); ?> !important;
			}
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['menu_item_gap'])) : ?>
		.menu-area .navbar ul li{
			padding-left:<?php echo esc_attr($konstruk_option['menu_item_gap']); ?>;
			padding-right:<?php echo esc_attr($konstruk_option['menu_item_gap']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['menu_item_gap2'])) : ?>
		.menu-area .navbar ul > li,
		.menu-cart-area,
		#rs-header .menu-responsive .sidebarmenu-search .sticky_search{
			padding-top:<?php echo esc_attr($konstruk_option['menu_item_gap2']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['menu_item_gap3'])) : ?>
		.menu-area .navbar ul > li,
		.menu-cart-area,
		#rs-header .menu-responsive .sidebarmenu-search .sticky_search{
			padding-bottom:<?php echo esc_attr($konstruk_option['menu_item_gap3']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['dropdown_menu_item_gap'])) : ?>
		.menu-area .navbar ul li ul.sub-menu li a{
			padding-left:<?php echo esc_attr($konstruk_option['dropdown_menu_item_gap']); ?>;
			padding-right:<?php echo esc_attr($konstruk_option['dropdown_menu_item_gap']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['dropdown_menu_item_gap2'])) : ?>
		.menu-area .navbar ul li ul.sub-menu{
			padding-top:<?php echo esc_attr($konstruk_option['dropdown_menu_item_gap2']); ?>;
			padding-bottom:<?php echo esc_attr($konstruk_option['dropdown_menu_item_gap2']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['dropdown_menu_item_separate'])) : ?>
		.menu-area .navbar ul li ul.sub-menu li a{
			padding-top:<?php echo esc_attr($konstruk_option['dropdown_menu_item_separate']); ?>;
			padding-bottom:<?php echo esc_attr($konstruk_option['dropdown_menu_item_separate']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['meaga_menu_item_gap'])) : ?>
		#rs-header .menu-area .navbar ul > li.mega > ul{
			padding-left:<?php echo esc_attr($konstruk_option['meaga_menu_item_gap']); ?>;
			padding-right:<?php echo esc_attr($konstruk_option['meaga_menu_item_gap']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['mega_menu_item_gap2'])) : ?>
		#rs-header .menu-area .navbar ul > li.mega > ul{
			padding-top:<?php echo esc_attr($konstruk_option['mega_menu_item_gap2']); ?>;
			padding-bottom:<?php echo esc_attr($konstruk_option['mega_menu_item_gap2']); ?>;
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['mega_menu_item_separate'])) : ?>
		#rs-header .menu-area .navbar ul li.mega ul.sub-menu li a{
			padding-top:<?php echo esc_attr($konstruk_option['mega_menu_item_separate']); ?>;
			padding-bottom:<?php echo esc_attr($konstruk_option['mega_menu_item_separate']); ?>;
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['breadcrumb_bg_color'])) : ?>
		.rs-breadcrumbs{
			background:<?php echo sanitize_hex_color($konstruk_option['breadcrumb_bg_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['breadcrumb_seperator_color'])) : ?>
		.rs-breadcrumbs .breadcrumbs-title span a:after, .rs-breadcrumbs .breadcrumbs-title span a:before,
		.rs-breadcrumbs .breadcrumbs-title a:before{
			background-color:<?php echo sanitize_hex_color($konstruk_option['breadcrumb_seperator_color']); ?>;			
		}
	<?php endif; ?>
	


	<?php if(!empty($konstruk_option['offcanvas_close_color'])) : ?>
		...
		{
			background:<?php echo sanitize_hex_color($konstruk_option['offcanvas_close_color']); ?> !important;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcanvas_close_hover_color'])) : ?>
		.sidenav li.nav-link-container:hover a.close-button span,
		.menu-wrap-off .inner-offcan .nav-link-container .close-button:hover span{
			background:<?php echo sanitize_hex_color($konstruk_option['offcanvas_close_hover_color']); ?> !important;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcan_bgs_color'])) : ?>
		.menu-wrap-off, body.page-template-page-single2 .mobile-menu-container, body.page-template-page-single .mobile-menu-container{
			background:<?php echo sanitize_hex_color($konstruk_option['offcan_bgs_color']); ?>;			
		}
	<?php endif; ?>


	<?php if(!empty($konstruk_option['offcan_txt_color'])) : ?>
		.sidenav p, .sidenav{
			color:<?php echo sanitize_hex_color($konstruk_option['offcan_txt_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcan_txt_color'])) : ?>
		body .sidenav .widget .widget-title{
			color:<?php echo sanitize_hex_color($konstruk_option['offcan_txt_color']); ?> !important;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcan_link_color'])) : ?>
		.sidenav .widget_nav_menu ul li a,
		.sidenav.offcanvas-icon .rs-offcanvas-right a,
		.sidenav .menu > li.menu-item-has-children:before,
		.sidenav a{
			color:<?php echo sanitize_hex_color($konstruk_option['offcan_link_color']); ?>;			
		}
	<?php endif; ?>
	

	<?php if(!empty($konstruk_option['offcan_link_social_color'])) : ?>
		ul.sidenav .menu > li.menu-item-has-children:before, 
		.sidenav .offcanvas_social li a i{
			color:<?php echo sanitize_hex_color($konstruk_option['offcan_link_social_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcan_border_color'])) : ?>
		.sidenav.offcanvas-icon .rs-offcanvas-right{
			border-color:<?php echo esc_attr($konstruk_option['offcan_border_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcan_link_hovers_color'])) : ?>
		.sidenav .widget_nav_menu ul li a:hover, 
		body.page-template-page-single .mobile-menu-container ul li a:hover, body.body.page-template-page-single2 .mobile-menu-container ul li a:hover,
		.sidenav a:hover{
			color:<?php echo sanitize_hex_color($konstruk_option['offcan_link_hovers_color']); ?>;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['offcan_link_bg_color'])) : ?>
		.sidenav .offcanvas_social li a i,
		ul.sidenav .menu > li.menu-item-has-children::before{
			background:<?php echo sanitize_hex_color($konstruk_option['offcan_link_bg_color']); ?>;			
		}
	<?php endif; ?>

	

	<?php if(!empty($konstruk_option['breadcrumb_text_color'])) : ?>
		.rs-breadcrumbs .page-title,
		...
		.rs-breadcrumbs .breadcrumbs-title span a span{
			color:<?php echo sanitize_hex_color($konstruk_option['breadcrumb_text_color']); ?> !important;			
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['breadcrumb_top_gap']) && !empty($konstruk_option['breadcrumb_bottom_gap'])) : ?>
		.rs-breadcrumbs .breadcrumbs-inner,
		#rs-header.header-style-3 .rs-breadcrumbs .breadcrumbs-inner{
			padding-top:<?php echo esc_attr($konstruk_option['breadcrumb_top_gap']); ?>;			
			padding-bottom:<?php echo esc_attr($konstruk_option['breadcrumb_bottom_gap']); ?>;			
	}
	<?php endif; ?>
	<?php if(!empty($konstruk_option['breadcrumb_top_gap_mobile']) && !empty($konstruk_option['breadcrumb_bottom_gap_mobile'])) : ?>
		@media only screen and (max-width: 767px) {
				body .rs-breadcrumbs .breadcrumbs-inner,
				body #rs-header.header-style-3 .rs-breadcrumbs .breadcrumbs-inner{
					padding-top:<?php echo esc_attr($konstruk_option['breadcrumb_top_gap_mobile']); ?> !important;			
					padding-bottom:<?php echo esc_attr($konstruk_option['breadcrumb_bottom_gap_mobile']); ?> !important;			
			}
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['blog_bg_color'])) : ?>
		body.single-post, body.blog, body.archive, body.single-services, body.single-mp-event{
			background:<?php echo sanitize_hex_color($konstruk_option['blog_bg_color']); ?>;					
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['breadcrumb_max_width'])) : ?>
		.rs-breadcrumbs .breadcrumbs-inner,
		.single-teams .rs-breadcrumbs .breadcrumbs-inner,
		.rs-breadcrumbs.text-center .breadcrumbs-inner{
			max-width:<?php echo esc_attr($konstruk_option['breadcrumb_max_width']); ?>;					
		}
	<?php endif; ?>

		<?php if(!empty($konstruk_option['preloader_text_color'])) : ?>
		.loader .loader-container:before{
			border-top-color: <?php echo sanitize_hex_color($konstruk_option['preloader_text_color']); ?> !important; 
		}		
	<?php endif; ?>

		<?php if(!empty($konstruk_option['preloader_animate_color'])) : ?>
		.loader .loader-container{
			border-color: <?php echo sanitize_hex_color($konstruk_option['preloader_animate_color']); ?> !important; 
		}		
	<?php endif; ?>

	<?php if(!empty($konstruk_option['preloader_bg_color'])) : ?>
		.loader .loader-container{
			background: <?php echo sanitize_hex_color($konstruk_option['preloader_bg_color']); ?> !important;  
		}
	<?php endif; ?>

	<?php if(!empty($konstruk_option['text_color'])) : ?>
		...
		.page-error.coming-soon .countdown-inner .time_circles div span{
			color: <?php echo esc_attr($konstruk_option['text_color']); ?>
		}
		.page-error.coming-soon .countdown-inner .time_circles div{
			border-color: <?php echo esc_attr($konstruk_option['circle_border_color']); ?>
		}

	<?php endif; ?>

	<?php if(!empty($konstruk_option['circle_primary_color'])) : ?>
		
		.page-error.coming-soon .countdown-inner .time_circles div{
			background:  <?php echo esc_attr($konstruk_option['circle_primary_color']);?>
		}		
...
<?php
	 ...
	 if ( class_exists( 'WooCommerce' ) && is_shop() || class_exists( 'WooCommerce' ) && is_product_tag()  || class_exists( 'WooCommerce' ) && is_product_category()  ) {
			...
			$padding_top           = get_post_meta($konstruk_shop_id, 'content_top', true);
			$padding_bottom        = get_post_meta($konstruk_shop_id, 'content_bottom', true);			
			$f_padding_top        = get_post_meta($konstruk_shop_id, 'footer__top__padding', true);	
	...
	if( empty($konstruk_option['enable_global'])) :
